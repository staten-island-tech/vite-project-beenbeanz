...
export const songsArr = [
  { name: "The 30th", artist: "Billie Eilish", album: "Guitar Songs", length: "4:41", image: "/guitar_songs.png" },
  { name: "Bittersuite", artist: "Billie Eilish", album: "Hit me Hard and Soft", length: "4:58", image: "/hmhas.png" },
  { name: "i love you", artist: "Billie Eilish", album: "WHEN WE ALL FALL ASLEEP, WHERE DO WE GO", length: "4:51", image: "/wwafawdwg.png" },
  { name: "Bad Guy", artist: "Billie Eilish", album: "WHEN WE ALL FALL ASLEEP, WHERE DO WE GO", length: "3:14", image: "/wwafawdwg.png" },
  { name: "Skinny", artist: "Billie Eilish", album: "Hit me Hard and Soft", length: "4:05", image: "/hmhas.png" },
  { name: "When the Party's Over", artist: "Billie Eilish", album: "WHEN WE ALL FALL ASLEEP, WHERE DO WE GO", length: "3:17", image: "/wwafawdwg.png" },
  { name: "Bury a Friend", artist: "Billie Eilish", album: "WHEN WE ALL FALL ASLEEP, WHERE DO WE GO", length: "3:13", image: "/wwafawdwg.png" },
  { name: "All the Good Girls Go to Hell", artist: "Billie Eilish", album: "WHEN WE ALL FALL ASLEEP, WHERE DO WE GO", length: "2:48", image: "/wwafawdwg.png" },
  { name: "Therefore I Am", artist: "Billie Eilish", album: "Happier Than Ever", length: "2:54", image: "/hte.png" },
  { name: "Blue", artist: "Billie Eilish", album: "Hit me Hard and Soft", length: "4:02", image: "/hmhas.png" },
  { name: "Your Power", artist: "Billie Eilish", album: "Happier Than Ever", length: "4:05", image: "/hte.png" },
  { name: "NDA", artist: "Billie Eilish", album: "Happier Than Ever", length: "3:06", image: "/hte.png" },
  { name: "Lost Cause", artist: "Billie Eilish", album: "Happier Than Ever", length: "3:28", image: "/hte.png" },
  { name: "Happier Than Ever", artist: "Billie Eilish", album: "Happier Than Ever", length: "4:57", image: "/hte.png" },
  { name: "My Future", artist: "Billie Eilish", album: "My Future (Single)", length: "3:28", image: "/hte.png" },
  { name: "Oxytocin", artist: "Billie Eilish", album: "Happier Than Ever", length: "3:28", image: "/hte.png" },
  { name: "Getting Older", artist: "Billie Eilish", album: "Happier Than Ever", length: "3:39", image: "/hte.png" },
  { name: "Male Fantasy", artist: "Billie Eilish", album: "Happier Than Ever", length: "4:49", image: "/hte.png" },
  { name: "I Didn't Change My Number", artist: "Billie Eilish", album: "Happier Than Ever", length: "3:16", image: "/hte.png" },
  { name: "Overheated", artist: "Billie Eilish", album: "Happier Than Ever", length: "3:23", image: "/hte.png" },
];
